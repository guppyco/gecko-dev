...
MOZ_APP_BASENAME=Guppy
MOZ_APP_NAME=guppy
MOZ_APP_VENDOR="Guppy Community"
...
MOZ_BRANDING_DIRECTORY=browser/branding/guppy
MOZ_OFFICIAL_BRANDING_DIRECTORY=browser/branding/guppy
