(() => {
  ...
  }, $parcel$global.parcelRequire94c2 = parcelRequire), parcelRequire.register("5KVwQ", (function(module, exports) {
    var $lkYZ8 = parcelRequire("lkYZ8"), $6U8vl = parcelRequire("6U8vl"), $hnMfj = parcelRequire("hnMfj"), $aCH1p = parcelRequire("aCH1p");
    document.querySelector("form").addEventListener("submit", (event => {
      event.preventDefault(), $parcel$interopDefault($lkYZ8)("#email, #password").css("border-color", "black"), 
      $parcel$interopDefault($lkYZ8)(".error-message").text("");
      const email = $parcel$interopDefault($lkYZ8)("#email").val(), pass = $parcel$interopDefault($lkYZ8)("#password").val();
      email && pass ? $parcel$interopDefault($6U8vl).runtime.sendMessage({
        message: "login",
        payload: {
          email: email,
          pass: pass
        ...
        "success" === response ? window.location.replace("../html/popup_account.html") : $parcel$interopDefault($lkYZ8)(".error-message").text("This account is not valid");
      })) : ($parcel$interopDefault($lkYZ8)("#email").attr("placeholder", "Enter an email."), 
      $parcel$interopDefault($lkYZ8)("#password").attr("placeholder", "Enter a password."), 
      $parcel$interopDefault($lkYZ8)("#email, #password").css("border-color", "red"));
    })), document.querySelector("#signup-link").addEventListener("click", (() => {
      $parcel$interopDefault($6U8vl).tabs.create({
        url: $hnMfj.env.guppyApiUrl + "/signup/"
      });
    })), window.addEventListener("load", (() => {
      $aCH1p.isAdsReplacerDisabled().then((checked => {
        !1 === checked ? $430ddfa3eec0ef4c$var$switchButton.checked = !1 : !0 === checked ? $430ddfa3eec0ef4c$var$switchButton.checked = !0 : document.querySelector(".switch-button-block").style.display = "none";
      }));
    }));
    const $430ddfa3eec0ef4c$var$switchButton = document.querySelector(".switch-button input");
    $430ddfa3eec0ef4c$var$switchButton.addEventListener("change", $aCH1p.toggleAdsReplacer);
