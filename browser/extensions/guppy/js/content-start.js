(() => {
  ...
  }, $parcel$global.parcelRequire94c2 = parcelRequire), parcelRequire.register("b8enF", (function(module, exports) {
    var $6U8vl = parcelRequire("6U8vl"), $bW5NO = parcelRequire("bW5NO");
      ...
      if (response && response.tabs) {
        ...
        response.tabs.every((tab => {
          if (tab.url === current) {
            ...
            return $bW5NO.sendPageView(tab.url, tab.title, referrer, null), !1;
          }
          return !0;
        }));
      }
