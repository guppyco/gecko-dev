(() => {
  ...
  }, $parcel$global.parcelRequire94c2 = parcelRequire), parcelRequire.register("hBS9k", (function(module, exports) {
    var $lkYZ8 = parcelRequire("lkYZ8"), $6U8vl = parcelRequire("6U8vl"), $hnMfj = parcelRequire("hnMfj"), $aCH1p = parcelRequire("aCH1p"), $bW5NO = parcelRequire("bW5NO"), $9frW1 = parcelRequire("9frW1");
    let $cd1fe54eddf806f6$var$count = 0;
    void 0 !== $parcel$interopDefault($6U8vl) && $parcel$interopDefault($lkYZ8).get($hnMfj.env.easylist).done((data => {
      let didScroll = !1;
      const easylistSelectors = data.split("\n").filter((line => line.startsWith("##"))).map((line => line.replace(/^##/, ""))).join(",");
      $cd1fe54eddf806f6$var$count = $aCH1p.adReplacer(easylistSelectors, $cd1fe54eddf806f6$var$count, $parcel$interopDefault($6U8vl)), 
      $parcel$interopDefault($lkYZ8)(document).ready((() => {
        $cd1fe54eddf806f6$var$count = $aCH1p.adReplacer(easylistSelectors, $cd1fe54eddf806f6$var$count, $parcel$interopDefault($6U8vl)), 
        $bW5NO.googleSearch();
      })), $parcel$interopDefault($lkYZ8)(window).scroll((() => {
        didScroll = !0;
      })), setInterval((() => {
        didScroll && ($cd1fe54eddf806f6$var$count = $aCH1p.adReplacer(easylistSelectors, $cd1fe54eddf806f6$var$count, $parcel$interopDefault($6U8vl)), 
        didScroll = !1);
      }), 1e4);
    })), $parcel$interopDefault($6U8vl).runtime.sendMessage({
      message: "askToLogin"
    }).then((response => {
      if (!response || !response.message || "success" !== response.message) {
        const today = $9frW1.getToday();
        $parcel$interopDefault($6U8vl).storage.local.set({
          isAskedLogin: today
        }), $parcel$interopDefault($6U8vl).runtime.sendMessage({
          message: "allTabs"
        }).then((response1 => {
          if (response1 && response1.tabs) {
            const current = window.location.href;
            response1.tabs.every((tab => tab.url !== current || (async function() {
              const today = $9frW1.getToday(), storage = await $parcel$interopDefault($6U8vl).storage.local.get([ "isAskedLoginHtml" ]);
              if (!storage.isAskedLoginHtml || storage.isAskedLoginHtml !== today) {
                ...
                message.className = "guppy-message", message.textContent = "You aren't logged into your Guppy account - You'll be missing out on cash back rewards until you login. Please click to login to Guppy", 
                ...
                remove.className = "guppy-remove", remove.textContent = "x", remove.addEventListener("click", (() => {
                  div.style.display = "none", $parcel$interopDefault($6U8vl).storage.local.set({
                    isAskedLoginHtml: today
                  });
                })), div3.append(message), div2.append(div3), div2.append(remove), div.append(div2), 
  ...
  })), parcelRequire.register("lkYZ8", (function(module, exports) {
    /*!
 ...
 */
  ...
  })), parcelRequire.register("6U8vl", (function(module, exports) {
    !function(global, factory) {
  ...
  })), parcelRequire.register("hnMfj", (function(module, exports) {
    $parcel$export(module.exports, "env", (() => $ca7a0246ebcb768a$export$8203705777ff332a));
    const $ca7a0246ebcb768a$export$8203705777ff332a = {
      guppyApiUrl: "https://guppy.co",
      easylist: "https://easylist.to/easylist/easylist.txt"
    };
  })), parcelRequire.register("aCH1p", (function(module, exports) {
    $parcel$export(module.exports, "adReplacer", (() => $7bbed33272b64bfd$export$ca9817005ae78c3)), 
    $parcel$export(module.exports, "toggleAdsReplacer", (() => $7bbed33272b64bfd$export$771a28fb8370e2ce)), 
    $parcel$export(module.exports, "isAdsReplacerDisabled", (() => $7bbed33272b64bfd$export$2c7fdd790aac4128));
    var $lkYZ8 = parcelRequire("lkYZ8"), $6U8vl = parcelRequire("6U8vl"), $9frW1 = parcelRequire("9frW1");
    async function $7bbed33272b64bfd$export$ca9817005ae78c3(selectors, count, browser) {
      const currentUrl = window.location === window.parent.location ? document.location.href : document.referrer, currentDomain = await $9frW1.getDomainFromUrl(currentUrl);
      return await $7bbed33272b64bfd$export$2c7fdd790aac4128(currentDomain) || $parcel$interopDefault($lkYZ8)(selectors).each((function() {
        if (!$parcel$interopDefault($lkYZ8)(this).hasClass("video-ads")) {
          const height = $parcel$interopDefault($lkYZ8)(this).height(), width = $parcel$interopDefault($lkYZ8)(this).width(), className = "replaced-img-" + count++, image = function(width, height) {
            const listImages = [ [ 125, 125 ], [ 180, 150 ], [ 200, 200 ], [ 250, 250 ], [ 970, 250 ], [ 970, 90 ], [ 300, 1050 ], [ 160, 600 ], [ 120, 240 ], [ 120, 600 ], [ 234, 60 ], [ 468, 60 ], [ 320, 50 ], [ 320, 100 ], [ 300, 600 ], [ 728, 90 ], [ 336, 280 ], [ 300, 250 ] ];
            for (let percent = 5; percent <= 30; percent += 5) for (const image of listImages) {
              if (width === image[0] && height === image[1]) return image;
              const widthDeviationRate = 100 * Math.abs(width - image[0]) / Math.max(width, image[0]), heightDeviationRate = 100 * Math.abs(height - image[1]) / Math.max(height, image[1]);
              if (widthDeviationRate <= percent && heightDeviationRate <= percent) return image;
            }
            let minDeviationRate = null, matchedImage = null;
            for (const image1 of listImages) {
              const totalRate = 100 * Math.abs(width - image1[0]) / Math.max(width, image1[0]) + 100 * Math.abs(height - image1[1]) / Math.max(height, image1[1]) + 150 * Math.abs(width / height - image1[0] / image1[1]);
              (null === minDeviationRate || minDeviationRate > totalRate) && (minDeviationRate = totalRate, 
              matchedImage = image1);
            }
            return matchedImage;
          }(width, height), imageName = "images/placeholder_" + image[0] + "x" + image[1] + ".jpg", imageUrl = browser.runtime.getURL(imageName);
          $parcel$interopDefault($lkYZ8)(this).replaceWith('<img class="' + className + '" src="' + imageUrl + '" />'), 
          $parcel$interopDefault($lkYZ8)("." + className).height(height).width(width).css("object-fit", "cover");
        }
      })), count;
    }
    async function $7bbed33272b64bfd$export$771a28fb8370e2ce() {
      const denyList = await $7bbed33272b64bfd$export$57bd53ae837a070d(), currentDomain = await $9frW1.getDomainFromUrl(), index = denyList.indexOf(currentDomain);
      this.checked && -1 === index ? denyList.push(currentDomain) : !this.checked && index > -1 && denyList.splice(index, 1), 
      $parcel$interopDefault($6U8vl).storage.local.set({
        denyList: denyList
      });
    }
    async function $7bbed33272b64bfd$export$2c7fdd790aac4128(domain = null) {
      null === domain && (domain = await $9frW1.getDomainFromUrl());
      const denyList = await $7bbed33272b64bfd$export$57bd53ae837a070d();
      return domain.includes(".") ? !(!denyList || !denyList.includes(domain)) : domain;
    }
    async function $7bbed33272b64bfd$export$57bd53ae837a070d() {
      let denyList = [];
      const storage = await $parcel$interopDefault($6U8vl).storage.local.get([ "denyList" ]);
      return storage.denyList && Array.isArray(storage.denyList) && (denyList = storage.denyList), 
      denyList;
    }
  })), parcelRequire.register("9frW1", (function(module, exports) {
    $parcel$export(module.exports, "getCookies", (() => $6bbb2f0dc0d94d8a$export$fad246312d8990d6)), 
    $parcel$export(module.exports, "getDomainFromUrl", (() => $6bbb2f0dc0d94d8a$export$c65b5836f62fb135)), 
    $parcel$export(module.exports, "getParameterByName", (() => $6bbb2f0dc0d94d8a$export$85e0bef117e28d1d)), 
    $parcel$export(module.exports, "getToday", (() => $6bbb2f0dc0d94d8a$export$bb0d4f8d7f9c4eb9));
    var $6U8vl = parcelRequire("6U8vl");
    function $6bbb2f0dc0d94d8a$export$bb0d4f8d7f9c4eb9() {
      const today = new Date, dd = String(today.getDate()).padStart(2, "0");
      return String(today.getMonth() + 1).padStart(2, "0") + "-" + dd + "-" + today.getFullYear();
    }
    async function $6bbb2f0dc0d94d8a$export$fad246312d8990d6(name) {
      return (await $parcel$interopDefault($6U8vl).storage.local.get([ name ]))[name];
    }
    function $6bbb2f0dc0d94d8a$export$85e0bef117e28d1d(name, url) {
      name = name.replace(/[[\]]/g, "\\$&");
      const results = new RegExp("[?&]" + name + "(=([^&#]*)|&|#|$)").exec(url);
      return results ? results[2] ? results[2] : "" : null;
    }
    async function $6bbb2f0dc0d94d8a$export$c65b5836f62fb135(url = null) {
      return null === url && (url = await async function() {
        const tabs = await $parcel$interopDefault($6U8vl).tabs.query({
          active: !0,
          currentWindow: !0
        });
  ...
  })), parcelRequire.register("bW5NO", (function(module, exports) {
    $parcel$export(module.exports, "googleSearch", (() => $8b099cbef6ecc576$export$ae9197424334d854)), 
    $parcel$export(module.exports, "sendPageView", (() => $8b099cbef6ecc576$export$8b2d0bfb1891f5d6));
    var $lkYZ8 = parcelRequire("lkYZ8"), $6U8vl = parcelRequire("6U8vl");
    async function $8b099cbef6ecc576$export$ae9197424334d854() {
      const origin = window.location.origin;
      if (origin.includes("://www.google.") || origin.includes("://google.")) {
        const terms = $parcel$interopDefault($lkYZ8)('input[name="q"]').val();
        terms && ($parcel$interopDefault($lkYZ8)("#search a").each((function() {
          let uri = $parcel$interopDefault($lkYZ8)(this).attr("href");
          if (uri) {
            const separator = uri.includes("?") ? "&" : "?";
            uri = uri + separator + "google_search_term=" + terms, $parcel$interopDefault($lkYZ8)(this).attr("href", uri), 
            $parcel$interopDefault($lkYZ8)(this).prop("onmousedown", null);
          }
        })), $parcel$interopDefault($6U8vl).runtime.sendMessage({
          message: "sendSearch",
          payload: {
    ...
    async function $8b099cbef6ecc576$export$8b2d0bfb1891f5d6(url, title, referrer, searchTerm) {
      return $parcel$interopDefault($6U8vl).runtime.sendMessage({
        message: "sendHistory",
        payload: {
          url: url,
          title: title,
          last_origin: referrer,
