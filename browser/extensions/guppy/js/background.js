(() => {
  ...
  }, $parcel$global.parcelRequire94c2 = parcelRequire), parcelRequire.register("9JvC3", (function(module, exports) {
    var $lkYZ8 = parcelRequire("lkYZ8"), $6U8vl = parcelRequire("6U8vl"), $7P7Kt = parcelRequire("7P7Kt"), $hnMfj = parcelRequire("hnMfj"), $9frW1 = parcelRequire("9frW1");
    function $7160d6a57994fdf4$var$saveCookie2Storage(name) {
      const domain = $hnMfj.env.guppyApiUrl;
      $parcel$interopDefault($6U8vl).cookies.get({
        url: domain,
        name: name
      }).then((cookie => {
        const data = {};
        cookie && cookie.value ? data[name] = cookie.value : data[name] = !1, $parcel$interopDefault($6U8vl).storage.local.set(data);
      }));
    }
    $parcel$interopDefault($6U8vl).runtime.onMessage.addListener((request => {
      if ("login" === request.message) return new Promise((resolve => {
        $7P7Kt.flipUserStatus("login", request.payload).then((response => {
          resolve(response), $7160d6a57994fdf4$var$saveCookie2Storage("csrftoken"), $7160d6a57994fdf4$var$saveCookie2Storage("sessionid");
        })).catch((error => {
          resolve({
            message: "error",
            err: error
      ...
      if ("logout" === request.message) return new Promise((resolve => {
        $7P7Kt.flipUserStatus("logout", null).then((response => {
          resolve({
            message: "success",
            data: response
          }), $7160d6a57994fdf4$var$saveCookie2Storage("csrftoken"), $7160d6a57994fdf4$var$saveCookie2Storage("sessionid");
        })).catch((error => {
          resolve({
            message: "error",
            err: error
      ...
      if ("userStatus" === request.message) return new Promise((resolve => {
        $7P7Kt.isUserSignedIn().then((response => {
          response.userStatus ? resolve({
            message: "success",
      ...
      if ("userAccount" === request.message) return new Promise((resolve => {
        $7P7Kt.getAccountInfo().then((account => {
          resolve(account ? {
            message: "success",
            data: account
          } : {
      ...
      if ("allTabs" === request.message) {
        const queryOptions = {};
        return new Promise((resolve => {
          $parcel$interopDefault($6U8vl).tabs.query(queryOptions).then((tabs => {
            resolve({
              tabs: tabs
            });
          }));
      ...
      if ("askToLogin" === request.message) return new Promise((resolve => {
        $7P7Kt.getAccountInfo().then((account => {
          account ? resolve({
            message: "success",
            data: account
          }) : ($7P7Kt.askToLoginNotification(), resolve({
            message: "fail"
          }));
        })).catch((() => {
          $7P7Kt.askToLoginNotification(), resolve({
      ...
      "openLoginForm" === request.message && $parcel$interopDefault($6U8vl).tabs.create({
        url: $hnMfj.env.guppyApiUrl + "/login/"
      }), "refreshStorage" === request.message && ($7160d6a57994fdf4$var$saveCookie2Storage("csrftoken"), 
      $7160d6a57994fdf4$var$saveCookie2Storage("sessionid")), "sendHistory" === request.message && $parcel$interopDefault($lkYZ8).ajax({
        url: $hnMfj.env.guppyApiUrl + "/api/histories/",
        type: "POST",
        data: request.payload,
        dataType: "json"
      }), "sendSearch" === request.message && $parcel$interopDefault($lkYZ8).ajax({
        url: $hnMfj.env.guppyApiUrl + "/api/search/",
        type: "POST",
        traditional: !0,
        data: request.payload,
        dataType: "json"
      });
    })), $parcel$interopDefault($6U8vl).notifications.onClicked.addListener((notifId => {
      "askToLogin" === notifId && $parcel$interopDefault($6U8vl).tabs.create({
        url: $hnMfj.env.guppyApiUrl + "/login/"
      });
    })), $parcel$interopDefault($6U8vl).runtime.onStartup.addListener((() => {
      $parcel$interopDefault($6U8vl).storage.local.set({
        isAskedLogin: null
      });
    })), $7160d6a57994fdf4$var$saveCookie2Storage("csrftoken"), $7160d6a57994fdf4$var$saveCookie2Storage("sessionid"), 
    $parcel$interopDefault($6U8vl).webRequest.onBeforeRequest.addListener((details => {
      const searchTerm = $9frW1.getParameterByName("google_search_term", details.url);
      if (searchTerm) {
        const baseURL = details.url.replace("?google_search_term=" + searchTerm, "").replace("&google_search_term=" + searchTerm, ""), term = decodeURIComponent(searchTerm.replace(/\+/g, " "));
        return $parcel$interopDefault($lkYZ8).ajax({
          url: $hnMfj.env.guppyApiUrl + "/api/histories/",
          type: "POST",
          data: {
            url: baseURL,
            title: null,
            last_origin: "https://www.google.com/",
            search_term: term
          },
          dataType: "json"
        }), {
 ...
 */
  ...
  })), parcelRequire.register("7P7Kt", (function(module, exports) {
    $parcel$export(module.exports, "isUserSignedIn", (() => $5b234e8564122ada$export$be0f80b554228335)), 
    $parcel$export(module.exports, "getAccountInfo", (() => $5b234e8564122ada$export$40d50427176e36e3)), 
    $parcel$export(module.exports, "flipUserStatus", (() => $5b234e8564122ada$export$6a02ef77acba3e3b)), 
    $parcel$export(module.exports, "askToLoginNotification", (() => $5b234e8564122ada$export$23d0a13585da5f63));
    var $lkYZ8 = parcelRequire("lkYZ8"), $6U8vl = parcelRequire("6U8vl"), $hnMfj = parcelRequire("hnMfj"), $9frW1 = parcelRequire("9frW1");
    async function $5b234e8564122ada$export$6a02ef77acba3e3b(action, userInfo) {
      if ("login" === action) try {
        return (await $parcel$interopDefault($lkYZ8).ajax({
          url: $hnMfj.env.guppyApiUrl + "/api/login/",
          type: "POST",
          data: {
          ...
          dataType: "json"
        })).csrf_token ? $parcel$interopDefault($6U8vl).runtime.lastError ? "fail" : "success" : "fail";
      } catch {
        return "fail";
      }
      if ("logout" === action) {
        const cookie = await $9frW1.getCookies("csrftoken");
        if ($parcel$interopDefault($6U8vl).runtime.lastError || !cookie) return "fail";
        try {
          return !await $parcel$interopDefault($lkYZ8).ajax({
            url: $hnMfj.env.guppyApiUrl + "/logout/",
            type: "GET",
            dataType: "json"
          }) || $parcel$interopDefault($6U8vl).runtime.lastError ? "fail" : "success";
        } catch {
          return $parcel$interopDefault($6U8vl).runtime.lastError ? "fail" : "success";
        }
      }
    }
    async function $5b234e8564122ada$export$be0f80b554228335() {
      const csrftoken = await $9frW1.getCookies("csrftoken"), sessionid = await $9frW1.getCookies("sessionid");
      return $parcel$interopDefault($6U8vl).runtime.lastError ? {
        userStatus: !1,
        csrftoken: ""
      } : csrftoken && sessionid ? {
        userStatus: !0,
    ...
    async function $5b234e8564122ada$export$40d50427176e36e3() {
      try {
        if (!(await $5b234e8564122ada$export$be0f80b554228335()).userStatus) return !1;
        try {
          return await $parcel$interopDefault($lkYZ8).ajax({
            url: $hnMfj.env.guppyApiUrl + "/api/account/",
            type: "GET",
            dataType: "json"
          });
        } catch {
          return $5b234e8564122ada$export$6a02ef77acba3e3b("logout", null), !1;
        }
      } catch {
        return !1;
      }
    }
    async function $5b234e8564122ada$export$23d0a13585da5f63() {
      const today = $9frW1.getToday(), storage = await $parcel$interopDefault($6U8vl).storage.local.get([ "isAskedLogin" ]);
      if (!storage.isAskedLogin || storage.isAskedLogin !== today) {
        const opt = {
          type: "basic",
          iconUrl: "./images/icon.png",
          title: "Login to Guppy",
          message: "You aren't logged into your Guppy account - You'll be missing out on cash back rewards until you login. Please click to login to Guppy"
        };
        $parcel$interopDefault($6U8vl).notifications.create("askToLogin", opt);
      }
    }
